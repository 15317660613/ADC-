...
Page({
    ...
    onShow: function () {
        ...
        if (this.data.currentTab == 0) {
            this.setData({hasMoreData: true, page: 1}, () => this.getList(1)
        )
            ;
        } else {
            this.setData({hasMoreData: true, page: 1}, () => this.getList(2)
        )
            ;
        }
    ...
    detailOnClick: function (e) {
      console.log('partycommittee2', 'detailOnClick');
      let nowDate = new Date();
      let that = this;
      console.log(e);
      if (util.throwQuickClick(nowDate, that.data._lastTime, 2000)) {
        wx.navigateTo({
          url: "../../pages/partycommitteedetail/partycommitteedetail?id=" + e.currentTarget.id
        })
      }
        that.setData({
          _lastTime: new Date()
