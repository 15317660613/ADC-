...
Page({
  ...
  onShows: function () {
    if (app.globalData.saveData !== '') {
      ...
      //     that.setData({
      //       journeyHeight: ((that.data.dataList[that.data.currentPage].scheduleDetailEOList.length) * 185) + 280
      //     })
      //   } else {
      //     that.setData({
      //       // journeyHeight:that.data.windowHeight - that.data.calendarHeight+40
      //       journeyHeight: ((that.data.dataList[that.data.currentPage].scheduleDetailEOList.length) * 185) + 280
      //     })
      //   }
      //   this.setData({
  ...
  getWeek() {
    ...
    // console.log(this.data.year, this.data.month - 1, this.data.day)
